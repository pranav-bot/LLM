...
with open("classification/target_variables.json", "w") as outfile: 
    json.dump(target_variables, outfile)

with open("classification/columns_to_drop.json", "w") as outfile: 
